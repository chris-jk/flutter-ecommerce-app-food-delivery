...
class ItemCard extends StatelessWidget {
  const ItemCard(MerchantItemsController itemsData, {Key? key})
      : super(key: key);
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: NetworkImage(itemsData.merchantItems[0][index].logom),
              fit: BoxFit.cover,
            ),
          ),
        ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    SmallText(
                      size: 16,
                      text: itemsData.merchantItems[0][index].categoryName,
                    ),
                    Gap(5),
                    // rating
                    IconAndText(
              ...
              BigText(
                text: itemsData.merchantItems[0][index].name,
              ),
              // show star rating
                  ...
                  Row(
                    children: [
                      ...
                      LineThroughSmallText(
                        size: 18,
                        text:
                            itemsData.merchantItems[0][index].price.toString(),
                      ),
                    ],
                  ),
                ],
